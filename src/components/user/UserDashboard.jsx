...
import { FaSearch, FaRegClock, FaTag, FaInfoCircle, FaFire } from "react-icons/fa";
...
export const UserDashboard = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <div className="relative min-h-screen flex flex-col justify-center items-center lg:px-32 px-5 bg-[url('./assets/img/hero.jpg')] bg-cover bg-no-repeat bg-center">
      ...
      <section id="offers-section" className="px-5 lg:px-32 py-16">
        <div className="mb-8 text-center">
          <h2 className="text-4xl font-bold text-gray-800 mb-2">Exclusive Offers</h2>

...
import { FaCheck, FaRupeeSign, FaCrown, FaBolt, FaPercentage } from "react-icons/fa";
        ...
        <div className="bg-gradient-to-r from-amber-500 to-orange-500 py-16 text-white text-center">
          <div className="container mx-auto px-4">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              Unlock exclusive food offers and maximum savings with Pocket Buddy Pro
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-100 py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                {
                  quote: "The yearly plan paid for itself in just 2 months! So many exclusive deals.",
                  name: "Priya K., Mumbai"
                },
                {
                  quote: "I save ₹3000+ annually on my lunch breaks with Pocket Buddy Pro.",
                  name: "Rahul S., Delhi"
                }
              ].map((testimonial, i) => (
                <div key={i} className="bg-white p-6 rounded-lg shadow-sm">
                  <p className="text-gray-700 italic">"{testimonial.quote}"</p>
                  <p className="mt-3 font-medium text-amber-600">— {testimonial.name}</p>
                </div>
              ))}
            </div>
          </div>
              ...
              {[
                {
                  ...
                  answer: "Yes! Cancel anytime and keep benefits until period ends."
                },
                {
                  question: "Do offers work with existing discounts?",
                  answer: "Yes! Pro discounts stack with restaurant promotions."
                },
                {
                  question: "How do I claim my extra savings?",
                  answer: "Discounts apply automatically at checkout in the app."
                },
                {
                ...
                <div key={i} className="border-b border-gray-100 pb-4">
                  <h3 className="font-medium text-orange-600">{item.question}</h3>

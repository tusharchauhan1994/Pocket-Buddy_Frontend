          ...
          >
            ...
            {profileDropdown && (
              <ul className="absolute right-0 bg-white border border-gray-300 rounded-lg p-3 shadow-md mt-2 w-32">
                <li>
                  <Link to="/user/favorites/restaurants" className="block px-3 py-1 hover:text-red-500 flex items-center gap-2">
                    <BiHeart size={16} />Restaurants
                  </Link>
                </li>
                <li>
                  <Link to="/user/favorites/offers" className="block px-3 py-1 hover:text-red-500 flex items-center gap-2">
                    <BiHeart size={16} />Offers
                  </Link>
                </li>
                <li>
                  <Link to="/user/profile" className="block px-3 py-1 hover:text-red-500 flex items-center gap-2">
                    <BiUser size={16} /> Profile
                  </Link>
                </li>
                <li>
